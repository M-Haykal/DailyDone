                ...
                <div class="d-flex">
                    ...
                    <div class="navbar-brand-box">
                        <a href="index.html" class="logo logo-dark">
                            <span class="logo-sm">
                                <img src="{{ asset('img/logo_hayproject.jpeg') }}" alt="" height="24">
                            </span>
                            <span class="logo-lg">
                                <img src="{{ asset('img/logo_hayproject.jpeg') }}" alt="" height="24"> <span
                                    class="logo-txt">Admin DailyDone</span>
                            </span>
                        </a>
                    ...
                    <div class="dropdown d-inline-block">
                        <button type="button" class="btn header-item bg-light-subtle border-start border-end"
                            ...
                            <img class="rounded-circle header-profile-user"
                                src="{{ auth()->user()->image_profile ? url('storage/images/' . auth()->user()->image_profile) : Avatar::create(auth()->user()->name)->toBase64() }}"
                                alt="Header Avatar">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            ...
                            <a class="dropdown-item" id="logout-btn"><i
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="text-sm-end d-none d-sm-block">
                                Develop by <a href="#!" class="text-decoration-underline">HayProject</a>
                            </div>
                        </div>
                    </div>
                </div>
