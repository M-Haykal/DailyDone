<div class="modal fade" tabindex="-1" id="createList" aria-hidden="true">
                ...
                <form action="{{ url('create-list') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('list_items') is-invalid @enderror" id="list-items"
                            name="list_items" value="{{ old('list_items') }}">
                        @error('list_items')
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('detail_list') is-invalid @enderror" id="detail-list"
                            name="detail_list" rows="3">{{ old('detail_list') }}</textarea>
                        @error('detail_list')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <input type="hidden" name="project_id" value="{{ auth()->user()->id }}">
